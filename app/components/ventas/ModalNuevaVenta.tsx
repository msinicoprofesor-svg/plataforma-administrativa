/* -------------------------------------------------------------------------- */
/* ARCHIVO: app/components/ventas/ModalNuevaVenta.tsx                         */
/* -------------------------------------------------------------------------- */
'use client';
import { useState, useMemo, useEffect } from 'react';
import { 
  MdLocationOn, MdRouter, MdAttachMoney, MdSignalCellularAlt, 
  MdCheckCircle, MdMap, MdCameraAlt, MdWifiTethering, 
  MdDns, MdSettingsInputAntenna, MdDescription, MdWarning, 
  MdVerified, MdSwapHoriz, MdFiberNew, MdDelete, MdLocalOffer, MdClose
} from "react-icons/md";
    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-md">
        <div className="bg-white rounded-[2.5rem] w-full max-w-2xl shadow-2xl animate-scale-in max-h-[90vh] flex flex-col overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-8 custom-scrollbar space-y-6">
                ...
                <div className="pt-4 flex gap-3 p-6 border-t border-gray-100">
                    <button type="button" onClick={onClose} className="flex-1 py-4 text-gray-400 font-bold hover:bg-gray-100 rounded-2xl transition-all">Cancelar</button>
